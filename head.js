...
async function create_images() {
  ...
  add_svg_button(tool_div, "260px", next_wallpaper_infos, "Hide the app so that it only logs the background filenames\nYou may bring it back by double clicking on its icon. ", hidden_mode_svg);
  add_svg_button(tool_div, "380px", next_wallpaper_infos, "Automatic size adjustment", auto_size_svg);
